...
#elif XRIF_TESTLOOP_DIFFERENCE == XRIF_DIFFERENCE_PREVIOUS0
   #define XRIF_TESTLOOP_DIFF_STR "previous0"
#elif XRIF_TESTLOOP_DIFFERENCE == XRIF_DIFFERENCE_FIRST
   #define XRIF_TESTLOOP_DIFF_STR "first"
#elif XRIF_TESTLOOP_DIFFERENCE == XRIF_DIFFERENCE_PIXEL0
   #define XRIF_TESTLOOP_DIFF_STR "pixel0"
#elif XRIF_TESTLOOP_DIFFERENCE == XRIF_DIFFERENCE_PIXELL
   #define XRIF_TESTLOOP_DIFF_STR "pixell"
#endif
